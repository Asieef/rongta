<template>
    <div>
        <div
            ...
            class="h-[600px] bg-cover bg-no-repeat bg-center bg-fixed grid grid-flow-col grid-cols-2"
        >
            ...
            <div class="col-span-1">
                <div class="bg-rongta opacity-95 h-full grid grid-flow-row">
                    <div class="flex justify-end flex-col px-12">
                        <h2 class="text-white uppercase text-3xl font-bold">About Rongta</h2>
                    ...
                    <div class="grid grid-flow-col grid-cols-2 justify-items-center">
                        <div class="col-span-1 flex flex-col gap-12">
                            <div class="flex gap-4">
                                <div
                                    class="border border-white rounded flex items-center justify-center w-20 h-20"
                                >
                                    <img src="/calendar.png" class="w-12" />
                                </div>
                                <div class="uppercase text-white">
                                    <h2 class="font-bold text-4xl">2009</h2>
                                    <p class="text-sm py-2">established</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                <div
                                    class="border border-white rounded flex items-center justify-center w-20 h-20"
                                >
                                    <img src="/flag.png" class="w-12" />
                                </div>
                                <div class="uppercase text-white">
                                    <h2 class="font-bold text-4xl">5000+</h2>
                                    <p class="text-sm py-2">Distributors</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-1 flex flex-col gap-12">
                            <div class="flex gap-4">
                                <div
                                    class="border border-white rounded flex items-center justify-center w-20 h-20"
                                >
                                    <img src="/building.png" class="w-12" />
                                </div>
                                <div class="uppercase text-white">
                                    <h2 class="font-bold text-4xl">20000+</h2>
                                    <p class="text-sm py-2">Company Area</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                <div
                                    class="border border-white rounded flex items-center justify-center w-20 h-20"
                                >
                                    <img src="/user.png" class="w-12" />
                                </div>
                                <div class="uppercase text-white">
                                    <h2 class="font-bold text-4xl">600+</h2>
                                    <p class="text-sm py-2">Customers (Mil)</p>
                                </div>
                            </div>
                        </div>
                    </div>
